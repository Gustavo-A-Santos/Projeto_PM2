...
export name='Gustavo Santos'
export email="gustavosantos4991@gmail.com"
export repositorio="https://github.com/Gustavo-A-Santos/Projeto_PM2.git";

#Daqui pra baixo mexa somente se for realmente necessário ou se souber o que está fazendo :P

export branch_name="aula-$(date -Idate)"
